...
public sealed class DanfossReadInputOperation : DanfossBaseDeviceOperation
{
    public override string Name => "read_input";
    private readonly IEnumerable<(string node, string mod, string point)> _addresses;

    public DanfossReadInputOperation(Uri endpoint, IEnumerable<(string node, string mod, string point)> addresses, ILoggerFactory loggerFactory)
