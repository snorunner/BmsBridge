...
public sealed class DanfossReadSensorOperation : DanfossBaseDeviceOperation
{
    public override string Name => "read_sensor";
    private readonly IEnumerable<(string node, string mod, string point)> _addresses;

    public DanfossReadSensorOperation(Uri endpoint, IEnumerable<(string node, string mod, string point)> addresses, ILoggerFactory loggerFactory)
